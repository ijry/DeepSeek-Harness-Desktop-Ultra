/**
 * dsh-plugin-repopanel — shared language resolution (zh / en).
 *
 ...
 * language from the `language` field of GET /dsh-plugin-repopanel/settings and
 * keeps its own inline copy of normalizeLang(). Keep the two in sync.
 *
 * @module dsh-plugin-repopanel/shared/lang
 */
