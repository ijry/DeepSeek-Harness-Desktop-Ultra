 ...
 *
 * The browser source is intentionally not copied raw into lib/ — the only browser
 * artifact is the wrapped bundle the DSH loader consumes.
 *
 * @module dsh-plugin-automation/scripts/build
 */
